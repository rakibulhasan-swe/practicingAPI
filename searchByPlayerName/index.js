        ...
        div.innerHTML = `
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">National Team: ${player.strTeam2}</p>
                    <p class="card-text">Club Team: ${player.strTeam}</p>
                    <p class="card-text">Date of birth: ${player.dateBorn}</p>
                    <p class="card-text">${player.strDescriptionEN.slice(0, 210)}</p>
...
const Error = () => {
    ...
    err.innerText = "Can't be empty! Try again with players name";
